...
export class InitialAssetModel1764000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKey(
      'asset_variables',
      'FK_asset_variables_variable_definition',
    );
    await queryRunner.dropForeignKey(
      'asset_variables',
      'FK_asset_variables_asset',
    );
    await queryRunner.dropIndex(
      'asset_variables',
      'IDX_asset_variables_asset_id',
    );
    ...
    await queryRunner.dropForeignKey(
      'asset_type_variables',
      'FK_asset_type_variables_variable_definition',
    );
    await queryRunner.dropForeignKey(
      'asset_type_variables',
      'FK_asset_type_variables_asset_type',
    );
    await queryRunner.dropIndex(
      'asset_type_variables',
      'IDX_asset_type_variables_asset_type_id',
    );
